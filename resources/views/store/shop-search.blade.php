...
@section('content')
                        ...
                        <div class="accordion-group">
                            <div class="accordion-heading">
                                <a class="accordion-toggle" data-toggle="collapse" href="#filterOne">دسته بندی ها <b
                                    ...
                                    {{--<a href="#" data-target="{{$category->id}}" class="selectable"><i class="box"></i> </a>--}}
                                    @foreach($categories as $category)
                                        <li style="padding-left: 150px" class="brandId"><input type="checkbox" id="brandId" value="{{$category->id}}" class="try">
                                            <a href=""><span class="pull-right">(
                                                    {{ App\Product::where('group_id' ,$category->id )->count() }})</span><b>{{$category->groupName}}</b></a>
                                    @endforeach
            ...
            <!--  ==========  -->
                ...
                <section class="span9 blocks-spacer">
                    ...
                    <div class="row popup-products" id="updateDiv">
                        ...
                        @if(\Request::ajax())
                            @include('partial.catrgoryProduct')
                        @else
                        <!--  ==========  -->
                            <!--  = Single Product =  -->
                            <!--  ==========  -->
    ...
    {{--$.post("/search",{value:thisElement.attr('data-target'), "_token": "{{ csrf_token() }}"});--}}
