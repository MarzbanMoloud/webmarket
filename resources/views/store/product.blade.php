            ...
            <div class="row blocks-spacer">
                ...
                <div class="span7">
                    ...
                    <div class="product-description">
                        <p>{{str_limit($product->detail, $limit = 30, $end = '...')}}</p>
                                ...
                                @foreach($product->comments as $comment)
                                    @if($comment->status==1)
                                        <div class="media-body">
                                            ...
                                            <div class="vote">
                                                <span class="cRate rateUp" id="{{$comment->id}}-up"><img  src="{{asset('images/like.png')}}"> </span>
                                                <span class="rateVal"
                                                      id="{{$comment->id}}-rate">{{$comment->rate}}</span>
                                                <span class="cRate rateDown" id="{{$comment->id}}-down"><img  src="{{asset('images/dislike.png')}}"></span>
                                            </div>
                                        </div>
                                    @endif
                                        <hr>
                ...
                @foreach($ralatedProducts as $relatedProduct)
                    <div class="span3">
                        <div class="product">
                            ...
                            <p>{{str_limit($relatedProduct->detail, $limit = 20, $end = '...')}}</p>
                        </div>
                    </div>
            @endforeach
            <!-- /product -->
